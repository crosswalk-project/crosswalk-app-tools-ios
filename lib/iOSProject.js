...
function iOSPlatform(PlatformBase, baseData) {
    /**
     * Interface for project implementations.
     * @constructor
     * @protected
     */
    function iOSProject(PlatformBase, baseData) {
    ...
    iOSProject.prototype.build =
        function(abis, release, callback) {
            ...
            project.parse(function (err) {
                ...
                var sdk = new SDK({'path': project_dir, 'id': packageId});
    ...
    return new iOSProject(PlatformBase, baseData);
}
