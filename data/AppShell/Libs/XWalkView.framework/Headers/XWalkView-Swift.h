...
@property (nonatomic, readonly, weak) XWalkView * __nullable webView;
@property (nonatomic, readonly, weak) NSThread * __nullable thread;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithWebView:(XWalkView * __nonnull)webView OBJC_DESIGNATED_INITIALIZER;
- (void)bind:(id __nonnull)object namespace:(NSString * __nonnull)namespace thread:(NSThread * __nullable)thread;
...
SWIFT_CLASS("_TtC9XWalkView9XWalkView")
@interface XWalkView : WKWebView
- (void)loadExtension:(id __nonnull)object namespace:(NSString * __nonnull)namespace;
